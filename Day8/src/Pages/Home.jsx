...
import AdvertisementImage from '../Assets/advertisement.jpg'; // Import your advertisement image
import { Link } from 'react-router-dom';

function Home() {
  const categoriesRef = useRef(null); // Create a ref for Categories section
  ...
  return (
    <div className='home'>
      ...
      <div className='featured-products'>
        <h2>Featured Products</h2> {/* Move the heading here */}
        ...
        {/* Add more featured product images and details as needed */}
      </div>
